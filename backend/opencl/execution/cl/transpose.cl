...
// __kernel void nhwc_to_nchw(BUFFER_OUT_OF_RANGE_PARAMS GLOBAL_WORK_GROUP_SIZE_DIM3 __global
//                  IN_DATA_TYPE *input,
//              __private const int in_height, __private const int in_channel,
...
//   if (in_nh >= global_size_dim2 || in_w >= global_size_dim1 ||
//       in_ch_blk >= global_size_dim0) {
//     return;
//   }
// #endif
//   int in_offset = mad24(mad24(mad24(in_n, H, in_h), W, in_w), C, in_ch_base);

//   int out_offset = mad24(mad24(mad24(in_n, C, in_ch_base), H, in_h), W, in_w);
...
// __kernel void
// nchw_to_nhwc(BUFFER_OUT_OF_RANGE_PARAMS GLOBAL_WORK_GROUP_SIZE_DIM3 __global
//                  IN_DATA_TYPE *input,
//              __private const int in_channel, __private const int in_width,
//              __global OUT_DATA_TYPE *output) {
...
// #ifndef NON_UNIFORM_WORK_GROUP
//   if (in_nc >= global_size_dim2 || in_h >= global_size_dim1 ||
//       in_w_blk >= global_size_dim0) {
//     return;
//   }
// #endif
//   int in_offset = mad24(mad24(mad24(in_n, C, in_c), H, in_h), W, in_w_base);
//   int out_offset = mad24(mad24(mad24(in_n, H, in_h), W, in_w_base), C, in_c);
//   IN_DATA_TYPE4 in_vec = (IN_DATA_TYPE4)(0);
